...
| Skill evidence AI pre-check | `SKILL_EVIDENCE_AI_PRECHECK_ENABLED` | off | Duplicate/stock-photo/AI-generated flags + certificate OCR for skill-evidence submissions. Skill evidence is always human-reviewed regardless; this only adds AI-assist on top. |

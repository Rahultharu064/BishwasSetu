...
export function GoogleLoginButton({ next = "/" }: { next?: string }) {
  ...
  return (
    <a
      href={googleAuthUrl}
      className="w-full flex items-center justify-center gap-3 rounded-xl border border-[#e7e7e1] bg-white hover:bg-[#fafaf7] active:scale-[0.98] text-[#1a1d1c] font-semibold py-3 text-sm transition-all duration-200 shadow-sm"
    >
      <svg
        className="h-5 w-5"
        viewBox="0 0 24 24"

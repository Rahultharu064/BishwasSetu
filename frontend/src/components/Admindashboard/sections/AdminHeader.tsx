        ...
        <header className="bg-white border-b border-gray-100 h-16 px-6 flex items-center justify-between sticky top-0 z-40">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="hidden md:flex items-center relative">
                    ...
                    <input
                        type="text"
                        placeholder="Search users, complaints..."
                ...
                <div className="relative">
                    ...
                    >
                        ...
                        <div className="hidden md:block text-left">
                            <p className="text-sm font-medium text-gray-700 leading-none">{profile?.name || 'Admin'}</p>
                    ...
                    {isProfileOpen && (
                        <>
                            ...
                            <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-40 transform origin-top-right transition-all">
                                ...
                                <button onClick={() => navigate('/admin/profile')} className="w-full px-4 py-2 text-sm text-gray-600 hover:bg-gray-50 flex items-center gap-2">
                                    <User size={16} /> Profile
                                </button>
                                <button onClick={() => navigate('/admin/settings')} className="w-full px-4 py-2 text-sm text-gray-600 hover:bg-gray-50 flex items-center gap-2">

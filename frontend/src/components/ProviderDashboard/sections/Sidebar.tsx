...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
    ...
    const navItems = [
        ...
        { path: '/provider/trust-score', label: 'Trust Score', icon: ShieldCheck },
        { path: '/provider/earnings', label: 'Earnings', icon: Wallet },
        { path: '/provider/profile', label: 'Profile & Skills', icon: User },
        { path: '/provider/kyc', label: 'KYC Verification', icon: FileCheck },
